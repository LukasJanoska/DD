...
public class ServerNewContactResultDto implements Serializable {
    ...
    public ServerNewContactResultDto(String responseCodeText, int responseCode, ContactsResponse contacts) {
    ...
    public void setContact(ContactsResponse contact) {
